...
function Footer() {
  return (
    <footer className="lg:h-[40dvh] bg-[#222327] text-[--color-description-dark] z-50 px-3">
...
const socialMedia = [
  {
    id: 1,
    username: "@SnackGraph",
    link: "https://www.linkedin.com/company/snackgraph/",
    icon: (
      <svg
        className="size-5 fill-[--color-description-dark]"
        viewBox="0 0 256 256"
        version="1.1"
  ...
  },
  {
    id: 2,
    username: "@SnackGraph",
    link: "https://github.com/snackgraph",
    icon: (
      <svg
        className="size-5 fill-[--color-description-dark]"
        viewBox="0 0 256 250"
  ...
  {
    id: 4,
    username: "hello@snackgraph.dev",
    link: "maito:hello@snackgraph.dev",
    icon: (
      <svg
        className="size-5 fill-[--color-description-dark]"
        xmlns="http://www.w3.org/2000/svg"
...
const resources = [
  ...
  },
  {
    id: 3,
    title: "Sytem status",
    link: "https://status.snackgraph.dev",
    icon: (
      <svg
        className="size-3 fill-[--color-description-dark]"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 256 256"
      >
